...
execution pace of each peer in comparison to the reference peer, which is the
one most advanced in time.
%
Regarding (c), we make peers leave and join the network periodically, possibly
creating partitions, and assert that they all catch up in real time.
