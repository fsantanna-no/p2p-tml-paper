...
%
This problem relates to consistency in distributed systems, but with the
additional requirement of a time deadline to reach consistency~\cite{melding}.
...
%, as desired by local-first software~\cite{local}:
