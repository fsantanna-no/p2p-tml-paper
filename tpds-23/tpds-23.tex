...
\begin{comment}
Os autores mencionam que em cenário com latência de 50ms e 25 eventos por
minuto, os pares precisaram retroceder 3\% do tempo.
Eles devem deixar claro porque isso é uma vantagem e qual a média de período de
tempo aceitável para retrocesso.
...
- Apenas aplicações com deadline mais curtos adequam-se melhor ao middleware.
Os autores precisam explicar no texto os resultados dos experimentos com maior
latência também (100ms, 250ms e 500ms).
\end{comment}
